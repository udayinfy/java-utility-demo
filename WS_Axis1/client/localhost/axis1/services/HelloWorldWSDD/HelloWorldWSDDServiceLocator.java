...
public class HelloWorldWSDDServiceLocator extends org.apache.axis.client.Service implements localhost.axis1.services.HelloWorldWSDD.HelloWorldWSDDService {
    ...
    public localhost.axis1.services.HelloWorldWSDD.HelloWorldWSDD getHelloWorldWSDD() throws javax.xml.rpc.ServiceException {
    ...
    public localhost.axis1.services.HelloWorldWSDD.HelloWorldWSDD getHelloWorldWSDD(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.axis1.services.HelloWorldWSDD.HelloWorldWSDDSoapBindingStub _stub = new localhost.axis1.services.HelloWorldWSDD.HelloWorldWSDDSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.axis1.services.HelloWorldWSDD.HelloWorldWSDD.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.axis1.services.HelloWorldWSDD.HelloWorldWSDDSoapBindingStub _stub = new localhost.axis1.services.HelloWorldWSDD.HelloWorldWSDDSoapBindingStub(new java.net.URL(HelloWorldWSDD_address), this);
                _stub.setPortName(getHelloWorldWSDDWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/axis1/services/HelloWorldWSDD", "HelloWorldWSDDService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/axis1/services/HelloWorldWSDD", "HelloWorldWSDD"));
        }
